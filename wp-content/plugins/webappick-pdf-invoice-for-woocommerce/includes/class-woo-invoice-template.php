        ...
        <table border="" class="product-table">
            ...
            <tr class="product-list-header">
				...
				<?php if ( 'invoice' === $this->template_type ) : ?>
                    <th class="price-column"><?php echo esc_html( woo_invoice_free_filter_label( 'Cost', $this->order, $this->template_type ) ); ?></th>
                    <th class="quantity-column"><?php echo esc_html( woo_invoice_free_filter_label( 'Qty', $this->order, $this->template_type ) ); ?></th>
                    <th class="total-column"><?php echo esc_html( woo_invoice_free_filter_label( 'Total', $this->order, $this->template_type ) ); ?></th>
